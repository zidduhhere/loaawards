const About = () => {
  ...
  return (
    <div className="w-screen min-h-screen flex-center px-24 md:px-30 z-50 overflow-hidden">
      <div className="text-loa-yellow font-display flex">
        <div className="flex flex-col md:flex-row md:flex-wrap md:items-center">
          <h3 className="order-1 text-[15vw] sm:text-[18vw] md:text-[10vh] drop-shadow-amber-300 drop-shadow-md">
            DRIVEN <br />
          ...
          <p className="order-3 md:order-2 text-loa-yellow font-body text-base md:text-2xl w-full md:w-[clamp(100px,30vw,200px)] leading-7 md:leading-8 opacity-80 mt-4 md:mt-0 md:ml-12">
            {paragraph}
          </p>
        </div>
      </div>
